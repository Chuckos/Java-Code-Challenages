...
public class Java_Anagrams {
	...
	static boolean isAnagram(String a, String b) {
		...
		// then compare for a equal match or not on both strings letters and sequence
	...
	public static String alphabSortString(String inputString) {
		...
		// apply Apply toCharArray() method on input string to create a char array for
		// input string.
		...
		// Return alphabetical order string
